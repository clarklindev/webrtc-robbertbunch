...
const ProDashboard = () => {
  ...
  useEffect(() => {
    ...
    //lesson71 - pull appointment data - below commented out...in favor of passing via socket (instead of sending it to backend)
        ...
        <div className="col-8">
          ...
          <div className="row num-2">
            <div className="col-4 calendar">
              <img
                src="https://s3.amazonaws.com/robertbunch.dev.publicresources/calendar.png"
                alt="calendar"
              />
            </div>
          </div>
